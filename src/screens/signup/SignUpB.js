...
import { inserirUsuario, validarUsuarioCelular, validarUsuarioEmail } from '../../service/app.service';
...
export default class SignUpB extends Component {
    ...
    if (nome !== '' && email !== '' && phone !== '' && password !== '') {
      ...
      if (retornoValidacaoCelular === "" && retornoValidacaoEmail === "") {
        ...
        this.setState({
          ...
          nome, email, phone, password, numberSMS
        }));
      } else {
        this.setState({ textModal: 'Já existe um usuário com esse numero de celular ou email', modalVisible: true })
      }
  ...
  onFacebookButtonPress = async () => {
    ...
    this.saveLoginFacebook(credentials.additionalUserInfo.profile);
  };
