...
const paper = require('../assets/img/paper.png');
const raffles = require('../assets/img/raffles.png');
        ...
        tabBarIcon: ({ color, focused, size }: Props) => {
          ...
          if (route.name === 'Inicio') {
            ...
            return (
              <Image
                source={paper}
                style={focused ? styles.orderActive : styles.orderInative}
              />
            );
            ...
            return (
              <View>
                <Image
                  source={raffles}
                  style={focused ? styles.rafflesActive : styles.rafflesInative}
                />
              </View>
            );
          }
